# Task 4 -- Wavecon Telecom, Impact of 5G Analysis

Part of the AtliQ Technologies Virtual Internship (Week 2, Task 4).
...
Wavecon isn't losing money because customers are spending less. It's losing money because fewer customers are sticking around, even though the ones who stay are paying more. The plans that offer more data per day are the ones holding up, and the low-data plans are bleeding customers fast.

## Recommendations

1. Scale up P1, it's the one plan actually growing post-5G
